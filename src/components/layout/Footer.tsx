      ...
      <div className="bg-nestly-black text-white rounded-3xl p-6 sm:p-8 md:p-12">
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            ...
            <Link to="/privacy-policy" className="border border-white/20 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-xs text-white/80 hover:bg-white/10 transition-colors">Privacy Policy</Link>
            <Link to="/cookies-policy" className="border border-white/20 rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-xs text-white/80 hover:bg-white/10 transition-colors">Cookies Policy</Link>
