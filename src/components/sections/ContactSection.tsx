...
export default function ContactSection() {
  return (
    <section className="page-enter mt-4">
      <div className="bg-nestly-green rounded-3xl p-6 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col gap-4">
            <div
              className="stagger-in relative bg-white rounded-3xl overflow-hidden h-[280px] md:h-[360px]"
            ...
            >
              ...
              <div className="bg-nestly-cream rounded-3xl p-6 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="font-display font-bold text-xs md:text-sm mt-1">+91 98765 43210</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            className="stagger-in bg-white rounded-3xl p-6 md:p-8"
