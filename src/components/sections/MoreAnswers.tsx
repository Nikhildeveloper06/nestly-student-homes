...
export default function MoreAnswers() {
  return (
    <section className="mt-4">
        ...
        href="#"
        className="bg-nestly-blue rounded-full py-5 px-6 md:px-10 flex items-center justify-end gap-2 hover:bg-nestly-blue/90 transition-colors"
      >
